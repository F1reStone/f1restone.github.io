...
html[data-theme="sky"] {
  /* Font families */
  --theme-font-sans:    'Wix Madefor Text', -apple-system, ui-sans-serif, system-ui, sans-serif;
  --theme-font-display: 'Neue Regrade', var(--theme-font-sans);
  --theme-font-mono:    'NKDuy Mono', ui-monospace, monospace;

  /* Typographic rhythm */
  --theme-heading-weight:   700;      /* headings font weight */
  --theme-heading-tracking: -0.10em;  /* letter-spacing on headings */
